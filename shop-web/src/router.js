...
import UserDetailsAdmin from './pages/AdminDashboard/views/UserDetailsAdmin'
...
const router = createRouter({
    ...
    routes: [
        ...
        {path: '/admin/dashboard', name: 'adminDashboard', redirect: '/admin/dashboard/products', component: AdminDashboard, meta: {requireAuth: true, role: 'ADMIN'}, children: [
            ...
            {path: '/admin/dashboard/user-details', name: 'UserDetailsAdmin', component: UserDetailsAdmin, meta: {requireAuth: true, role: 'ADMIN'}},
        ]},
